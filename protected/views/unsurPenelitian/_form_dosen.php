 ...
 <div class="form-body">
	...
	<div class="form-group">
		...
		<?php $this->widget('zii.widgets.jui.CJuiDatePicker', 
                        array(
                            'model'=>$model,
                            'attribute'=>'TGL_PENELITIAN',
                            'value'=>$model->TGL_PENELITIAN,
                           // 'class'=>'form-control',
                            'options'=>array(
                                'dateFormat'=>'yy-mm-dd',
                             //   'showOn'=>'button',
	...
	<div class="form-actions fluid">
		...
		<?php echo CHtml::submitButton($model->isNewRecord ? 'Simpan' : 'Save', array('class'=>'btn btn-primary')); ?>
                <?php echo CHtml::link('Kembali',array('unsurPenelitian/bdosen&id='.$model->PENGAJUAN_KE,'id_dosen'=>$model->ID_DOSEN),array('class'=>'btn btn-success btn-md'));?>
            </div>
	</div>
<?php $this->endWidget(); ?>
</div><!-- form -->