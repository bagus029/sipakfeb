...
<table style=" width:100%;border-bottom: 2px solid black">
    <tr>
        <td style="width:100%">
            ...
            <div align="center" style="font-size:15px">MELAKSANAKAN KEGIATAN PENGABDIAN PADA MASYARAKAT</div>
			</b>
        </td>
    </tr>
</table>
...
<table style=" width:100%;" >
	...
	<?php
                        ...
                        $criteria->addColumnCondition(array('ID_UNSUR_PENGABDIAN' => $x['ID_UNSUR_PENGABDIAN']));
...
<table style="width:100%;">
	<tr>
		<td>
			<div align="left" style="font-size:12px;line-height: 20px;">Telah melakukan kegiatan pengabdian pada masyarakat sebagai berikut :</div>
		</td>
	</tr>
</table>
</div>
...
<table border="1px;" style=" width:100%;border-collapse: collapse;" >
	<tr>
		...
		<th align="center" style="font-size: 12px;">Kegiatan Pengabdian Pada Masyarakat</th>
		<th align="center" style="font-size: 12px;">Bentuk</th>
		...
		<th align="center" style="font-size: 12px;">Keterangan</th>
	</tr>
	<?php 
        $no=0;
        $jumlah_angka=0;
	...
	<tr>
            ...
            <td align="center" style="font-size: 12px;"><?php echo $x['KEGIATAN_PENGABDIAN']?></td>
            <td align="center" style="font-size: 12px;"><?php echo $x['BENTUK_PENGABDIAN']?></td>
            <td align="center" style="font-size: 12px;"><?php echo $x['TEMPAT_PENGABDIAN']?></td>
            <td align="center" style="font-size: 12px;"><?php echo $x['TGL_PENGABDIAN']?></td>
            <td align="center" style="font-size: 12px;"><?php echo $x['NILAI_PENGABDIAN']?></td>
            <td align="center" style="font-size: 12px;"><?php echo $x['BUKTI_PENGABDIAN']?></td>
	</tr>
        <?php
