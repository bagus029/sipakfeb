 ...
 <div class="form-body">
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'ID_DOSEN',array('class'=>'col-md-3 control-label')); ?>
            <div class="col-md-4">
		<?php echo $form->textField($model,'ID_DOSEN',array('class'=>'form-control','readonly'=>true)); ?>
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'NILAI_PENDIDIKAN',array('class'=>'col-md-3 control-label')); ?>
            <div class="col-md-4">
		<?php echo $form->textField($model,'NILAI_PENDIDIKAN',array('class'=>'form-control')); ?>
		<?php echo $form->error($model,'NILAI_PENDIDIKAN'); ?>
            </div>
	</div>
