...
<div class="form-body">
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'NILAI_PENUNJANG',array('class'=>'col-md-3 control-label')); ?>
            <div class="col-md-4">
		<?php echo $form->textField($model,'NILAI_PENUNJANG',array('class'=>'form-control')); ?>
		<?php echo $form->error($model,'NILAI_PENUNJANG'); ?>
            </div>
	</div>
