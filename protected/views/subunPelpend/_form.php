<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->errorSummary($model); ?>
		...
		<?php echo $form->labelEx($model,'ID_SUBPELPEND',array('class'=>'col-md-3 control-label')); ?>
            <div class="col-md-4">
		<?php echo $form->textField($model,'ID_SUBPELPEND',array('class'=>'form-control')); ?>
		<?php echo $form->error($model,'ID_SUBPELPEND'); ?>
            </div>
	</div>

	<div class="form-group">
		<?php echo $form->labelEx($model,'SUBPELPEND',array('class'=>'col-md-3 control-label')); ?>
            <div class="col-md-4">
		<?php echo $form->textArea($model,'SUBPELPEND',array('class'=>'form-control')); ?>
		<?php echo $form->error($model,'SUBPELPEND'); ?>
            </div>
	</div>
