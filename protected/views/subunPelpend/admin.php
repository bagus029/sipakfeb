...
<div class="portlet-title">
  <div class="caption">
	<i class="fa fa-cogs"></i> Sub Unsur Pelaksanaan Pendidikan  </div>
    <div class="actions">
...
<?php $this->widget('ext.GroupGridView', array(
	...
	'columns'=>array(
                   array('name'=>'ID_SUBPELPEND',
                         'type'=>'raw',
                         'header'=>'Id',
                         'value'=>'CHtml::encode($data->ID_SUBPELPEND)',
                         //'htmlOptions'=>array('width'=>'5%'),
                         ),
                   array('name'=>'SUBPELPEND',
                         'type'=>'raw',
                         'header'=>'Sub Unsur Pelaksanaan Pendidikan',
                         'value'=>'CHtml::encode($data->SUBPELPEND)',
