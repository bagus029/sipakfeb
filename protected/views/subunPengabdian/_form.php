<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->errorSummary($model); ?>
		...
		<?php echo $form->labelEx($model,'ID_SUBUNPENGAB',array('class'=>'col-md-3 control-label')); ?>
            <div class="col-md-4">
		<?php echo $form->textField($model,'ID_SUBUNPENGAB',array('class'=>'form-control')); ?>
		<?php echo $form->error($model,'ID_SUBUNPENGAB'); ?>
            </div>
	</div>

	<div class="form-group">
		<?php echo $form->labelEx($model,'SUBUNPENGAB',array('class'=>'col-md-3 control-label')); ?>
            <div class="col-md-4">
		<?php echo $form->textArea($model,'SUBUNPENGAB',array('class'=>'form-control')); ?>
		<?php echo $form->error($model,'SUBUNPENGAB'); ?>
            </div>
	</div>
